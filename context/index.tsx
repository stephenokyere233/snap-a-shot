...
const AppProvider: React.FC<IAppProvider> = ({ children }) => {
    ...
    return (
        <AppContext.Provider value={{ isShowwcaseDataFetched, setIsShowwcaseDataFetched, isTwitterDataFetched, setIsTwitterDataFetched, selectedBGColor, setSelectedBGColor, showStats, setShowStats }}>
            {children}
        </AppContext.Provider>
    )
}
